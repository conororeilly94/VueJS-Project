                                    ...
                                    <form class="user" @submit.prevent="supplierInsert" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="exampleInputFirstName"
                                                    placeholder="Enter Shop Name" v-model="form.shopname">
        ...
        methods: {
            onFileSelected(event) {
                ...
                if(file.size > 1048770) {
                    Notification.image_validation(); // Go to the image_validation method in Notification.js
                } else {
                    let reader = new FileReader();
                    reader.onload = event => {
                        this.form.photo = event.target.result // photo in the data->form above
